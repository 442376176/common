...
public BigDecimal calculate(String x, String y) {
    ...
    BigDecimal multiply = bigDecimal1.subtract(bigDecimal2).multiply(BigDecimal.valueOf(100000));
    BigDecimal bigDecimal = multiply.multiply(multiply).setScale(2, BigDecimal.ROUND_HALF_UP);
    return bigDecimal;
}
```