...
public class MailConfig {
     ...
     */
    private String host = EMailAddr.QQ_MAIL_SMTP.getHost();     //邮件服务器主机host,目前只支持SMTP协议(163或qq)  网易默认是：smtp.163.com
    private String port = EMailAddr.QQ_MAIL_SMTP.getPort();      //端口号
    private String from = "442376176@qq.com";
    private String username = "442376176@qq.com";
    private String s = "bluxifdeysvzcbaa";
